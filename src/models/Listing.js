...
const listingSchema = new mongoose.Schema({
  ...
  monetization: {
    ...
    leadAccess: { type: String, enum: ['open', 'paid'], default: 'paid' },
    contactFeeAmount: { type: Number, min: 0, default: 5 },
    contactFeeCurrency: { type: String, default: 'USD' },
    postingFeeRequired: { type: Boolean, default: false },
    postingFeeAmount: { type: Number, min: 0, default: 0 },
    postingFeeCurrency: { type: String, default: 'UGX' },
    postingFeeStatus: { type: String, enum: ['not_required', 'pending', 'paid'], default: 'not_required' },
    postingFeeReference: String,
